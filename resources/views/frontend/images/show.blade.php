                                    ...
                                    @if ($generatedImage->visibility)
                                        ...
                                        <div class="ai-image-details-item">
                                            ...
                                            <div class="textarea-btn">
                                                <textarea id="htmlCode" class="form-control bg-light" rows="5" readonly><img alt="{{ $generatedImage->prompt }}" src="{{ route('images.secure', [hashid($generatedImage->id), $generatedImage->filename]) }}" /></textarea>
