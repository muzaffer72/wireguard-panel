...
@section('content')
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="grid grid-cols-2">
          ...
          <a href="{{ route('admin.transactions.index') }}" class="text-sm font-medium text-white hover:bg-cyan-600 rounded-lg p-2">{{ admin_lang('View All') }}</a>
        </div>
                ...
                <thead class="bg-dark-50">
                  <tr>
                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">
                      Transaction
                    </th>
                    <th scope="col" class="p-4 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">
                      Date & Time
                ...
                <tbody class="bg-dark">
                  <tr>
                    ...
                    <td class="p-4 whitespace-nowrap text-sm font-semibold text-white-900">
