    ...
    <form id="billiongroup-submited-form" action="{{ route('admin.settings.seo.store') }}" method="POST">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="form-label">{{ admin_lang('Site Title') }} :<span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label">{{ admin_lang('Site Description') }} :<span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label">{{ admin_lang('Site Keywords') }} : <span class="text-danger">*</span></label>
